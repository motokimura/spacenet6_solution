...
if __name__ == '__main__':
    ...
    # Building polygon
    polygon_dir = os.path.join(args.data_dir, 'Buildings')
    polygon_filenames = os.listdir(polygon_dir)
    polygon_filenames.sort()

    # Multi-spectral
    ms_image_dir = os.path.join(args.data_dir, 'MS')
    ...
    psms_image_dir = os.path.join(args.data_dir, 'PS-MS')
    ...
    mask_filenames = os.listdir(args.mask_dir)
    mask_filenames.sort()
