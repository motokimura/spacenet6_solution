...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=["SAR-Intensity", "PS-RGBNIR", "PS-RGB", "PAN"],
...
def get_image_shape(image_subdir):
    if image_subdir == "SAR-Intensity":
        ...
        image_width, image_height, image_channel = 900, 900, 4
    elif image_subdir == "PS-RGB":
        image_width, image_height, image_channel = 900, 900, 3
...
if __name__ == "__main__":
    ...
    image_width, image_height, image_channel = get_image_shape(args.image_subdir)
