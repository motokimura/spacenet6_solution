...
_C.INPUT.BUILDING_DIR = '/data/spacenet6/footprint_boundary_mask/labels'
...
# Transforms
_C.TRANSFORM = CN()
_C.TRANSFORM.TRAIN_RANDOM_CROP_SIZE = (448, 448)
...
_C.TRANSFORM.ALIGN_SAR_ORIENTATION = False
_C.TRANSFORM.TARGET_SAR_ORIENTATION = 0  # 0: north, 1: south

# Data loader
_C.DATALOADER = CN()
_C.DATALOADER.TRAIN_BATCH_SIZE = 20
...
_C.MODEL.BACKBONE = 'efficientnet-b3'
...
_C.SOLVER.LR_MULTISTEP_MILESTONES = [100,]
_C.SOLVER.LR_MULTISTEP_GAMMA = 0.1
_C.SOLVER.LR_ANNEALING_T_MAX = 150
